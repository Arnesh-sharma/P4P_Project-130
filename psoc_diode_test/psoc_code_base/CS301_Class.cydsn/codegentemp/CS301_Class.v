...
module ADC_SAR_v3_10_4 (
	...
	cy_clock_v1_0
		#(.id("33cec502-00c3-4e38-a43b-35d7590566f7/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("33cec502-00c3-4e38-a43b-35d7590566f7/7e0d1a6c-1235-4546-a71b-ea6e528924f8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__diode_pin_net;
	wire [0:0] tmpFB_0__diode_pin_net;
	wire [0:0] tmpIO_0__diode_pin_net;
	wire [0:0] tmpINTERRUPT_0__diode_pin_net;
	electrical [0:0] tmpSIOVREF__diode_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		diode_pin
		 (.oe(tmpOE__diode_pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__diode_pin_net[0:0]}),
		  .analog({Net_4353}),
		  .io({tmpIO_0__diode_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__diode_pin_net),
		  .interrupt({tmpINTERRUPT_0__diode_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__diode_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
