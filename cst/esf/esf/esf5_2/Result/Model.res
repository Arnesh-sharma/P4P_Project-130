...
lifetime=s:solverstart
result=s:0
treepath=s:1D Results\LT Solver\Signals\default (potential,Vframe1)
files=s:signal_default (potential,Vframe1)_lf_res.sig
...
lifetime=s:solverstart
result=s:0
treepath=s:1D Results\LT Solver\Signals\default (potential,Vframe2)
files=s:signal_default (potential,Vframe2)_lf_res.sig
...
result=s:1
DCMerge=i:1
treepath=s:1D Results\LT Solver\Energy\component1\solid1
files=s:MQSTDenergy_component1\solid1.sig
