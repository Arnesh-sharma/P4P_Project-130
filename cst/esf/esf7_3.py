...
cst_file = r"C:\Users\npat025\OneDrive - The University of Auckland\mystuff\cst\esf\esf7_3.cst"
...
for vf1 in vflist1:
    ...
    #   Run a simulation    
        ...
        # q = np.array([vf1, vf2, q1, q2, q3, q4])
    #    print("vf:%4.2f V, q (pC): %4.2f, %4.2f %4.2f %4.2f" % (vf1, q1*1e12, q2*1e12, q3*1e12, q4*1e12 ))
        # print("vf:%4.2f V, q (pC): %4.2f, %4.2f, %4.2f, %4.2f %4.2f %4.2f" % (vf1, q1*1e12, q2*1e12, (q1-q2)*1e12, q3*1e12, q4*1e12, (q3-q4)*1e12 ))
        # print("vf1:%4.2f V, vf2:%4.2f V,  q (pC): %4.2f, %4.2f, %4.2f, %4.2f %4.2f %4.2f" % (vf1, vf2, q1*1e12, q2*1e12, (q1-q2)*1e12, q3*1e12, q4*1e12, (q3-q4)*1e12 ))



        # cg = np.array([vf1, vf2, cgnd12, cgnd21, cgnd34, cgnd43]) 
        # print("vf1:%4.2f V, vf2:%4.2f V,  C gnd(pF): %4.2f, %4.2f %4.2f, %4.2f" % (vf1, vf2, cgnd12*1e12, cgnd21*1e12, cgnd34*1e12, cgnd43*1e12))


        # cl = np.array([vf1, vf2, cLumped12, cLumped21, cLumped34, cLumped43])
        # print("vf1:%4.2f V, vf2:%4.2f V,  C lumped(pF): %4.2f, %4.2f, %4.2f, %4.2f" % (vf1, vf2, cLumped12*1e12, cLumped21*1e12, cLumped34*1e12, cLumped43*1e12))
...
# print('S1 Charge difference')
# d['q1']- d['q2']*1e12

# print('S2 Charge difference')
# d['q3']- d['q4']*1e12

# print('Capacitance S1 (pF)')
# d[['cg21', 'cg21','cl12', 'cl12']]*1e12

# print('Capacitance S2 (pF)')
# d[['cg34', 'cg43','cl34', 'cl43']]*1e12
